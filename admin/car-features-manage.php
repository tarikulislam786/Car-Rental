...
<div id="content" class="pmd-content inner-page">
    ...
    $data = '<div class="table-responsive pmd-card pmd-z-depth">
            <table class="table table-mc-red pmd-table">
                ...
                <tbody>';
$query = "SELECT carfeatures.car_id, capacity, aircondition, kmpl, carname FROM carfeatures INNER JOIN cars ON carfeatures.car_id = cars.car_id ORDER BY carname ASC LIMIT $page1, 10";
$result= $conn->query($query);
   ...
   // pagination
        ...
        if($totalpage > 1)
        {
            ...
            $data .= '<li class="pagination-item--wide first"> <a class="pagination-link--wide first" href="car-features-manage.php?page=1">First</a> </li>';
            for($i = $startCounter; $i <= $loopcounter; $i++)
            {
                if($i== $_GET["page"]){
                    $data .= '<li class="pagination-item is-active"> <a class="pagination-link" href="car-features-manage.php?page='.$i.'">'.$i." ".'</a> </li>';
                }else{
                    $data .= '<li class="pagination-item"> <a class="pagination-link" href="car-features-manage.php?page='.$i.'">'.$i." ".'</a> </li>';
                }
            }
