    ...
    <path fill="#C9C8C8" d="M307.555,407.535h-9.108v10.264h9.108V407.535z M287.725,407.535v6.232h9.109v-6.232H287.725z
        ...
        <li class="dropdown pmd-dropdown"> 
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">  
                <i class="material-icons md-dark pmd-md" style="color:green;">room</i>
                <span class="media-body">Car types</span>
                <div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
            </a> 
            <ul class="dropdown-menu">
                <li><a href="cartype-add.php">Add car type</a></li>
                <li><a href="cartype-manage.php">Manage car type</a></li>
            </ul>
        </li>
        <li class="dropdown pmd-dropdown"> 
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">  
                <i class="material-icons md-dark pmd-md" style="color:green;">room</i>
                <span class="media-body">Cars</span>
                <div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
            </a> 
            <ul class="dropdown-menu">
                <li><a href="car-add.php">Add cars</a></li>
                <li><a href="car-manage.php">Manage cars</a></li>
            </ul>
        </li>

        <li class="dropdown pmd-dropdown"> 
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">  
                <i class="material-icons md-dark pmd-md" style="color:green;">business</i>
                <span class="media-body">Car Features</span>
                <div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
            </a> 
            <ul class="dropdown-menu">
                <li><a href="car-features-add.php">Add Car Features</a></li>
                <li><a href="car-features-manage.php">Manage Car Features</a></li>
            </ul>
        </li>
